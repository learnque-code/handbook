...
var getOwnKeys = (function () {
    if (typeof Object.getOwnPropertySymbols == "function") {
        return function (object) { return __spreadArrays$3(Object.getOwnPropertyNames(object), Object.getOwnPropertySymbols(object)); };
    }
    else {
...
var TargetSet = /** @class */ (function () {
    ...
    TargetSet.prototype.findAll = function () {
        ...
        return targetNames.reduce(function (targets, targetName) { return __spreadArrays$2(targets, _this.findAllTargets(targetName), _this.findAllLegacyTargets(targetName)); }, []);
    };
